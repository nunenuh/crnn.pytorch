...
class SpatialTransformer(nn.Module):
    ...
    def __init__(self, F, img_size, imrec_size, img_channel=1):
        """ Based on RARE TPS
        input:
        ...
        self.F = F
        self.I_size = img_size
        self.I_r_size = imrec_size  # = (I_r_height, I_r_width)
        self.I_channel_num = img_channel
...
if __name__ == "__main__":
    ...
    # print(gridgen)
    # print('fiducial_points',gridgen.C)
    # print('sampling_grid',gridgen.P)
    
    out_gridgen = gridgen.build_P_prime(out_locnet)
    print(out_gridgen)
